...
- [🌟xitu/gold-miner-掘金翻译计划，可能是世界最大最好的英译中技术社区](https://github.com/xitu/gold-miner)

### Videos

- [独立开发这的修炼攻略](https://boxueio.com/)
...
- [Swift-MemoryLayout swift 内存布局](https://github.com/TannerJin/Swift-MemoryLayout)
- [CombineCocoa-Combine publisher bridges for Cocoa Controls (UIControl) in UIKit](https://github.com/freak4pc/CombineCocoa)
- [🌟MovieSwiftUI-SwiftUI & Combine app using MovieDB API](https://github.com/Dimillian/MovieSwiftUI)
- [RxCombine-Bi-directional type bridging between RxSwift and Apple's Combine framework](https://github.com/freak4pc/RxCombine)
- [CombineRxSwiftPerformance-A test suite comparing the performance of Combine and RxSwift](https://github.com/quickbirdstudios/CombineRxSwiftPerformance)
- [🌟carekit-apple/CareKit-CareKit is an open source software framework ](https://github.com/carekit-apple/CareKit)
- [apple/swift-corelibs-foundation-The Foundation Project, providing core utilities](https://github.com/apple/swift-corelibs-foundation)
- [🌟微信：Tencent/matrix](https://github.com/tencent/matrix)
- [🌟kstenerud/KSCrash-具有业界领先的卡顿堆栈捕获能力，同时兼备崩溃捕获能力。](https://github.com/kstenerud/KSCrash)
...
- [youngsoft/YSBlockHook-A runtime block hook mechanism(一个运行时的 block hook 机制)。](https://github.com/youngsoft/YSBlockHook)
...
- [Ramotion/swift-ui-animation-components-and-libraries](https://github.com/Ramotion/swift-ui-animation-components-and-libraries)
- [🌟xmartlabs/Eureka-Elegant iOS form builder in Swift](https://github.com/xmartlabs/Eureka)
- [🌟mozilla-mobile/firefox-ios](https://github.com/mozilla-mobile/firefox-ios)
- [🌟fullstackio/FlappySwift-swift implementation of flappy bird.](https://github.com/fullstackio/FlappySwift)
- [🌟Ramotion/folding-cell-FoldingCell is an expanding content cell with animation](https://github.com/Ramotion/folding-cell)
...
- [🌟Tencent/MMKV-An efficient, small mobile key-value storage framework developed by WeChat. ](https://github.com/Tencent/MMKV)
...
- [Juanpe/SkeletonView-An elegant way to ...](https://github.com/Juanpe/SkeletonView)
...
- [IBM-Swift/Kitura-A Swift web framework and HTTP server](https://github.com/IBM-Swift/Kitura)
- [lexrus/LTMorphingLabel-Graceful morphing effects for UILabel written in Swift.](https://github.com/lexrus/LTMorphingLabel)
...
- [Yalantis/Koloda-KolodaView is a class designed to simplify the implementation of Tinder like cards on iOS.](https://github.com/Yalantis/Koloda)
...
- [🌟Swift for TensorFlow Project Home Page ](https://github.com/tensorflow/swift)
- [SwipeCellKit/SwipeCellKit](https://github.com/SwipeCellKit/SwipeCellKit)
- [WenchaoD/FSPagerView-FSPagerView is an elegant Screen Slide Library](https://github.com/WenchaoD/FSPagerView)
- [exyte/Macaw-Powerful and easy-to-use vector graphics Swift library with SVG support](https://github.com/exyte/Macaw)
...
- [vikmeup/SCLAlertView-Swift-Beautiful animated Alert View. Written in Swift](https://github.com/vikmeup/SCLAlertView-Swift)
...
- [cgoldsby/LoginCritter](https://github.com/cgoldsby/LoginCritter)
- [JakeLin/SwiftLanguageWeather](https://github.com/JakeLin/SwiftLanguageWeather)
- [malcommac/SwiftDate](https://github.com/malcommac/SwiftDate)
- [daltoniam/Starscream-Websockets in swift for iOS and OSX](https://github.com/daltoniam/Starscream)
...
- [Swift-AI/Swift-AI-The Swift machine learning library.](https://github.com/Swift-AI/Swift-AI)
...
- [🌟微信:Matrix-iOS 耗电监控](https://mp.weixin.qq.com/s?__biz=MzAwNDY1ODY2OQ==&mid=2649287119&idx=1&sn=47dfa0f48a062fe70d5e88dd742ee240&scene=21#wechat_redirect)
- [🌟iOS微信内存监控](https://mp.weixin.qq.com/s/CiqMlEIp1Ir2EJSDGgMooQ)
- [🌟iMatrix for iOS macOS 耗电监控原理](https://github.com/Tencent/matrix/wiki/Matrix-for-iOS-macOS-%E8%80%97%E7%94%B5%E7%9B%91%E6%8E%A7%E5%8E%9F%E7%90%86)
